                ...
                <div className="overflow-hidden">
                  <table className="w-full table-fixed border-collapse text-left">
                    <thead className="border-b border-gray-200 bg-gray-50 text-[11px] font-black uppercase tracking-wider text-gray-500">
                      <tr>
                        <th className="w-[34%] px-3 py-3">
                          Invoice
                        </th>

                        <th className="w-[18%] px-2 py-3 text-center">
                          Jam
                        </th>
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-3 py-3 align-top">
                              <div className="flex flex-col items-start gap-1.5">
                                <Link
                                  ...
                                  className={`block break-all text-xs font-black leading-4 hover:underline md:text-sm ${
                                    isVoid
                                      ? "text-red-600"
                                      : "text-pink-600"
                                  }`}
                                ...
                                {isVoid && (
                                  <div className="flex flex-col items-start gap-1">
                                    <span className="inline-flex rounded-full border border-red-200 bg-red-100 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-red-700">
                                      ✕ VOID
                                    </span>

                                    {trx.void_reason && (
                                      <span className="text-[9px] font-medium leading-3 text-red-500">
                                        {trx.void_reason}
                                      </span>
                                    )}
                                  </div>
                                ...
                                {!isVoid && (
                                  <span className="inline-flex rounded-full border border-emerald-200 bg-emerald-50 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-emerald-700">
                                    ✓ SELESAI
                                  </span>
                                )}
                              </div>
                            ...
                            <td className="px-2 py-3 text-center font-mono text-[11px] text-gray-500 md:text-xs">
                              ...
                              {isVoid && trx.voided_at && (
                                <div className="mt-1 text-[9px] font-sans font-bold text-red-400">
                                  VOID
                                </div>
                              )}
                            </td>
                            ...
                            <td className="p-4 text-center">
                              <div className="flex flex-col items-center gap-1">
                                {method === "QRIS" ? (
                                  ...
                                  <span className="inline-flex items-center justify-center rounded-full border border-purple-200 bg-purple-50 px-3 py-1 text-[11px] font-black text-purple-700">
                                    🏦 TRANSFER
                                  </span>
                                ) : (
                            ...
                            {/* Total */}
                            <td
                              className={`px-3 py-3 text-right text-xs font-black md:text-sm ${
                                isVoid
